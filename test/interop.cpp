...
int main(int argc, const char **argv) {
    ...
    data_cycle<vcd_tracer::value<uint8_t>, uint8_t, 3> pt_sig{ passthru_inner, "pt_sig", 0x00, 0xAA, 0x55 };
    data_cycle<vcd_tracer::value<uint8_t, 4>, uint8_t, 2> a_sig{ m_a, "a_sig", 0x3, 0xC };
    data_cycle<vcd_tracer::value<uint16_t>, uint16_t, 2> dig_sig{ m_1st, "dig_sig", 0x1234, 0xABCD };
    data_cycle<vcd_tracer::value<uint8_t>, uint8_t, 2> spc_sig{ m_special, "spc_sig", 0x5A, 0xA5 };
    ...
    data_cycle<vcd_tracer::value<uint32_t>, uint32_t, 4> deep_sig{ deep8, "deep_sig", 0xDEADBEEFu, 0xCAFEBABEu, 0x12345678u, 0x5A5A5A5Au };
    ...
    data_cycle<vcd_tracer::value<double>, double, 8> dbl{ l1, "dbl", 0.0, 1.5, -3.25, 100.0, DBL_MIN, DBL_MAX, -DBL_MAX, DBL_EPSILON };
    data_cycle<vcd_tracer::value<float>, float, 7> flt{ l0_l0, "flt", 0.0f, 2.5f, -1.0f, FLT_MIN, FLT_MAX, -FLT_MAX, FLT_EPSILON };
    ...
    data_cycle<vcd_tracer::value<uint8_t, 4>, uint8_t, 6> u4{ l0_l0_l0, "u4", 0x0, 0x5, 0xA, 0xF, 0x5, 0xA };
    data_cycle<vcd_tracer::value<uint8_t, 7>, uint8_t, 6> u7{ l0, "u7", 0x00, 0x7F, 0x01, 0x55, 0x2A, 0x5A };
    data_cycle<vcd_tracer::value<uint8_t>, uint8_t, 7> u8{ l0, "u8", 0x00, 0x7F, 0xFF, 0x01, 0x55, 0xAA, 0x5A };
    data_cycle<vcd_tracer::value<uint16_t, 9>, uint16_t, 6> u9{ l0, "u9", 0x000, 0x100, 0x1FF, 0x155, 0x0AA, 0x15A };
    data_cycle<vcd_tracer::value<uint16_t, 15>, uint16_t, 6> u15{ l0, "u15", 0x0000, 0x3FFF, 0x7FFF, 0x5555, 0x2AAA, 0x5A5A };
    data_cycle<vcd_tracer::value<uint16_t>, uint16_t, 7> u16{ l0, "u16", 0x0000, 0x8000, 0xFFFF, 0x0001, 0x5555, 0xAAAA, 0x5A5A };
    data_cycle<vcd_tracer::value<uint32_t, 17>, uint32_t, 6> u17{ l0, "u17", 0x00000, 0x10000, 0x1FFFF, 0x15555, 0x0AAAA, 0x15A5A };
    data_cycle<vcd_tracer::value<uint32_t, 24>, uint32_t, 6> u24{ l0_l0_l0_l0, "u24", 0x000000, 0x7FFFFF, 0xFFFFFF, 0x555555, 0xAAAAAA, 0x5A5A5A };
    data_cycle<vcd_tracer::value<uint32_t, 31>, uint32_t, 7> u31{ l0, "u31", 0x00000000, 0x3FFFFFFF, 0x7FFFFFFF, 0x00000001, 0x55555555, 0x2AAAAAAA, 0x5A5A5A5A };
    data_cycle<vcd_tracer::value<uint32_t>, uint32_t, 7> u32{ l0, "u32", 0x00000000u, 0x80000000u, 0xFFFFFFFFu, 0x00000001u, 0x55555555u, 0xAAAAAAAAu, 0x5A5A5A5Au };
    data_cycle<vcd_tracer::value<uint64_t, 33>, uint64_t, 7> u33{ l0, "u33", 0x0ull, 0x100000000ull, 0x1FFFFFFFFull, 0x1ull, 0x155555555ull, 0x0AAAAAAAAull, 0x15A5A5A5Aull };
    data_cycle<vcd_tracer::value<uint64_t>, uint64_t, 8> u64{ l0, "u64", 0x0ull, 0x7FFFFFFFFFFFFFFFull, 0xFFFFFFFFFFFFFFFFull, 0x1ull, 0x8000000000000000ull, 0x5555555555555555ull, 0xAAAAAAAAAAAAAAAAull, 0x5A5A5A5A5A5A5A5Aull };
    ...
    // Open files for output
    {
        ...
        std::sort(sorted.begin(), sorted.end(), [](const data_cycle_base *a, const data_cycle_base *b) {
